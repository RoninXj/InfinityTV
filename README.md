...
本项目是在 **MoonTV** 基础上进行的深度二次开发版本，从 **v4.3.1** 版本开始，持续迭代至当前 **v5.6.1**，累计新增 50+ 重大功能模块，300+ 细节优化。所有新增功能详见 [CHANGELOG](CHANGELOG)。
...
#### 📱 界面体验优化
- **英雄横幅**：首页自动轮播的英雄横幅，渐变背景设计，提升视觉吸引力
